...
export const adminStageTwoForm = Yup.object({
  ...
  teamLeaderEmail: Yup.string().required('This field is required'),
  teamLeaderContact: Yup.string().required('This field is required'),
  teamLeaderCategory: Yup.string().required('This field is required'),
  teamLeaderId: Yup.string().required('This field is required'),
  organisationName: Yup.string().required('This field is required'),
  teamMembers: Yup.string().required('This field is required'),
  teamMemberCategory: Yup.string().required('This field is required'),
  ...
  receivedFunding: Yup.string().required('This field is required'),
  fundingAgency: Yup.string().required('This field is required'),
  fundSanctionDate: Yup.string().required('This field is required'),
  fundingAmount: Yup.string().required('This field is required'),
  registeredCompany: Yup.string().required('This field is required'),
  companyType: Yup.string().required('This field is required'),
  cinUdhyamRegistrationNo: Yup.string().required('This field is required'),
  companyRegistrationDate: Yup.string().required('This field is required'),
  dpiitRecognised: Yup.string().required('This field is required'),
  dpiitCertificateNo: Yup.string().required('This field is required'),
  incubatedAt: Yup.string().required('This field is required'),
  ipFilledGranted: Yup.string().required('This field is required'),
  ipTypes: Yup.string().required('This field is required'),
  ipDetails: Yup.string().required('This field is required'),
  revenueGeneration: Yup.string().required('This field is required'),
  numOfEmployees: Yup.string().required('This field is required'),
