...
const Form = () => {
  ...
  const handleSubmit = (event) => {
    ...
    // Alert();
    const postId = 'users/startup-details'; // assume this is the dynamic parameter
    const payload = formData;
    api.post(postId, payload)
      .then((res) => {
    ...
    //     headers: {
    //       Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFzcHA3NzVAZ21haWwuY29tIiwiZmlyc3ROYW1lIjoiU3VtaXQiLCJsYXN0TmFtZSI6IlBhbmRleSIsInBob25lTnVtYmVyIjoiNzc1OTkxNzE1NCIsImlhdCI6MTY4MjM1NDEzNiwiZXhwIjoxNjgyOTU4OTM2fQ.IPhNEZ0JcuugRDa7pQUryP3bNJ6y2Kbb7rJmZd6dL4s`,
    //     },
    //   })
    //   .then((res) => {
    //     // localStorage.setItem('pu-edc-auth-token', res.data.token)
