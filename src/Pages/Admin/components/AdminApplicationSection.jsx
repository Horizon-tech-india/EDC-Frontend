...
const AdminApplicationSection = () => {
  ...
  const NumButtons = (props) => {
    return <button onClick={props.numsBtn}> {props.pageNum}</button>
  }
  const ApplicationFooter = (props) => {
    return (
      <div className="all-applications-footer">
        <div className="previous-page" onClick={props.prevPage}>
          Previous page
        </div>
        ...
        <div className="next-page" onClick={props.nextPage}>
          Next Page
        </div>
      </div>
    )
