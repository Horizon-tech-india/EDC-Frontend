          ...
          <div className="content-items">
            ...
            <div className="column2 text-container">
              ...
              <div className="section1-text">
                ...
                <p>
                  {" "}
                  Our focus is to facilitate and assist the students
                  significantly by providing{" "}
                </p>
                <p>
                  resources and appropriate mentoring to transform their
                  potential into
                </p>
                <p> business leaders of tomorrow.</p>
              </div>

              <SubmitBtn variant="contained">Submit your Idea</SubmitBtn>
            </div>
          </div>
        </div>
      </div>
